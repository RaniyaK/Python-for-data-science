...
Label(root, image = drapp_logo ,bg = "#F7AC40").place(x=560, y=630)
...
trans_btn = Button(root,text = 'Translate', font = 'Arial 12 bold',pady = 5, command = Translate, bg = 'Red',activebackground = 'green' )
trans_btn.place (x=30,y=555)
